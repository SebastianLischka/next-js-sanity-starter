...
import { fetchSupportedLanguagesFromSettings } from "./lib/fetch-supported-languages";
    ...
    ...(isStudioI18nEnabled
      ? [
          documentInternationalization({
            ...
            supportedLanguages: (client) => fetchSupportedLanguagesFromSettings(client),
          }),
        ]
      : []),
    presentationTool({
