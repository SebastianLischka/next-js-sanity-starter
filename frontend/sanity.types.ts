...
// Query: *[_type == "navigation"] | order(_updatedAt desc){    _type,    _key,    links[]{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  }
...
// Query: *[_type == "page" && defined(slug) && coalesce(language, $defaultLanguage) == $language]{slug}
...
// Query: *[_type == "post" && defined(slug) && coalesce(language, $defaultLanguage) == $language] | order(_createdAt desc){    "language": coalesce(language, $defaultLanguage),    title,    slug,    excerpt,    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },}
...
// Query: *[_type == "post" && defined(slug) && coalesce(language, $defaultLanguage) == $language]{slug}
export type POSTS_SLUGS_QUERY_RESULT = Array<{
  slug: Slug | null;
}>;

// Source: ../frontend/sanity/queries/settings.ts
// Variable: SETTINGS_I18N_QUERY
// Query: *[_type == "settings"][0]{  supportedLanguages[]{    id,    title  },  defaultLanguage}
export type SETTINGS_I18N_QUERY_RESULT = {
  supportedLanguages: Array<{
    id: string | null;
    title: string | null;
  }> | null;
...
// Query: *[_type == "settings"][0]{  _type,  siteName,  supportedLanguages[]{    id,    title  },  defaultLanguage,  logo{    dark{      ...,      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      }    },    light{      ...,      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      }    },    width,    height,  },  copyright}
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    '*[_type == "page" && defined(slug) && coalesce(language, $defaultLanguage) == $language]{slug}': PAGES_SLUGS_QUERY_RESULT;
    '*[_type == "post" && slug.current == $slug && coalesce(language, $defaultLanguage) == $language][0]{\n    "language": coalesce(language, $defaultLanguage),\n    title,\n    slug,\n    image{\n      \n  ...,\n  asset->{\n    _id,\n    url,\n    mimeType,\n    metadata {\n      lqip,\n      dimensions {\n        width,\n        height\n      }\n    }\n  }\n\n    },\n    body[]{\n      \n  ...,\n  markDefs[]{\n    ...,\n    _type == "link" => {\n      \n    _key,\n    ...,\n    "href": select(\n      isExternal => href,\n      defined(href) && !defined(internalLink) => href,\n      @.internalLink->slug.current == "index" => "/",\n      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,\n      "/" + @.internalLink->slug.current\n    )\n\n    }\n  },\n  _type == "image" => {\n    \n  ...,\n  asset->{\n    _id,\n    url,\n    mimeType,\n    metadata {\n      lqip,\n      dimensions {\n        width,\n        height\n      }\n    }\n  }\n\n  }\n\n    },\n    author->{\n      name,\n      image {\n        ...,\n        asset->{\n          _id,\n          url,\n          mimeType,\n          metadata {\n            lqip,\n            dimensions {\n              width,\n              height\n            }\n          }\n        },\n        alt\n      }\n    },\n    _createdAt,\n    _updatedAt,\n    \n  meta{\n    title,\n    description,\n    noindex,\n    image{\n      \n  ...,\n  asset->{\n    _id,\n    url,\n    mimeType,\n    metadata {\n      lqip,\n      dimensions {\n        width,\n        height\n      }\n    }\n  }\n\n    }\n  }\n,\n}': POST_QUERY_RESULT;
    '*[_type == "post" && defined(slug) && coalesce(language, $defaultLanguage) == $language] | order(_createdAt desc){\n    "language": coalesce(language, $defaultLanguage),\n    title,\n    slug,\n    excerpt,\n    image{\n      \n  ...,\n  asset->{\n    _id,\n    url,\n    mimeType,\n    metadata {\n      lqip,\n      dimensions {\n        width,\n        height\n      }\n    }\n  }\n\n    },\n}': POSTS_QUERY_RESULT;
    '*[_type == "post" && defined(slug) && coalesce(language, $defaultLanguage) == $language]{slug}': POSTS_SLUGS_QUERY_RESULT;
    '*[_type == "settings"][0]{\n  supportedLanguages[]{\n    id,\n    title\n  },\n  defaultLanguage\n}': SETTINGS_I18N_QUERY_RESULT;
